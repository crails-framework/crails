...
{
public:
  DockerBuildOdbCompiler(const Crails::Renderer& renderer, Crails::RenderTarget& target, Crails::SharedVars& vars) :
...
{
  DockerBuildOdbCompiler(renderer, target, vars).render();
}
...
class render_DockerBuildBuild2 : public Crails::Template
{
public:
  render_DockerBuildBuild2(const Crails::Renderer& renderer, Crails::RenderTarget& target, Crails::SharedVars& vars) :
    Crails::Template(renderer, target, vars), 
    build2_version(Crails::cast< string >(vars, "build2_version",  "0.17.0")), 
...
{
  render_DockerBuildBuild2(renderer, target, vars).render();
}
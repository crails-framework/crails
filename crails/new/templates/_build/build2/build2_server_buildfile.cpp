...
class render_Build2ServerBuildfile : public Crails::Template
{
public:
...
void render_build2_server_buildfile(const Crails::Renderer& renderer, Crails::RenderTarget& target, Crails::SharedVars& vars)
{
  render_Build2ServerBuildfile(renderer, target, vars).render();
}
...
{
public:
  ProjectPublicIndexHtml(const Crails::Renderer* renderer, Crails::SharedVars& vars) :
...
std::string render_project_public_index_html(const Crails::Renderer* renderer, Crails::SharedVars& vars)
{
  return ProjectPublicIndexHtml(renderer, vars).render();
}